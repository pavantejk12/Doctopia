        ...
        <div className='content flex justify-center flex-grow '>
          ...
          <div className='lg:w-9/12 w-10/12 h-full   flex flex-col gap-5 lg:gap-0 lg:flex-row '>
               ...
               <div className=' w-full h-full flex flex-col justify-center '>
                   ...
                   <div className='lg:h-3/4 h-full  flex justify-end '  >
                       ...
                       <div className='flex flex-col justify-around gap-5 mt-10 mb-10 lg:w-3/5 w-full bg-white rounded-3xl border-[1px] border-gray-400 pl-5 pr-5 '>
                           ...
                           <div className='h-14 bg-yellow rounded-md   flex justify-center w-full mt-10'>
               ...
               }} className={`outline-none  my-auto border-none  bg-yellow w-full h-12 `} type="email" name="email" placeholder="Email"  ></input>
                              
                              </div>
                           </div>

                           <div className='h-14 bg-yellow rounded-md   flex justify-center w-full '>
                              <div className='my-auto flex w-full pl-3 pr-3 gap-3'>
                                 <div className='h-7 w-7 my-auto'>
                   ...
                   setPasswd(e.target.value)
               ...
               }} className={`outline-none my-auto border-none  bg-yellow w-full h-12`} type="password" name="passwd" placeholder="Password"></input>
                           ...
                           <div onClick={async ()=>{
                                ...
                                const body = {
                                  fullName: `BrainyDoc${Math.floor(Math.random()*(999-100+1)+100)}`,
                                  email:email,
                                  password:passwd,
                                  number:d1
                              ...
                              if (!req.ok) {
                                  // If the response status is not ok (in the 200-299 range)
                                  const errorMessage:any = await req.json(); // Get the error message from the response
                              ...
                              if(req.status ===201){
                                  ...
                                  const req2 = await fetch('/api/customers/login',{
                                    headers: {
                                      "Content-Type": "application/json",
                                    },
                                    method: "POST",
                            ...
                            }}  className='cursor-pointer h-14 bg-orange  rounded-md flex justify-center '  >
                               <h1 className='my-auto text-white'>Sign Up</h1>
                           </div>
                           ...
                           <div className='flex justify-center mb-5'>
                                <p className='text-sm text-gray-500'>Already have an account? <Link href={'/login'}><span className='text-black'>Login</span></Link></p>
                            </div>
